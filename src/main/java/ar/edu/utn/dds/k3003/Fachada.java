...
;
  ...
  private DonadorDTO dyEBuscarDonadorPorID(String donadorIDString){
    ...
    if(!llamadosPredeterminados){
      System.out.println("Previo a buscarDonador");
      System.out.println(donadorIDString);
      resultado = this.donadoresYEntidades.buscarDonador(donadorIDString);
      System.out.println("El donador ID es");
      System.out.println(donadorIDString);
  ...
  private void logiGestionarDonacion(String depositoID, String donacionID, String productoID, Integer cantidad){
    if(!llamadosPredeterminados){
      PaqueteDTO paquete = new PaqueteDTO(null, donacionID, productoID, cantidad);
      this.logistica.postDonacion(depositoID, paquete);
    }else{
